...
public interface LedgerService {
     ...
     * 송금이 실패했음을 기록한다.
     */
    LedgerPairSnapshot markTransferFailed(IdempotencyKey idempotencyKey, String reason);

    /**
     * 송금이 성공적으로 정산되었음을 기록한다.
     */
    LedgerPairSnapshot markTransferSettled(IdempotencyKey idempotencyKey, Instant settledAt);

    /**
     * 현재 송금 상태를 조회한다.
     */
    TransferStatus getStatus(IdempotencyKey idempotencyKey);
}
