...
public class InventoryController implements InventoryApi {
    ...
    public ApiResult<InventoryListResponse> getInventory(@PathVariable Long characterId) {
        log.info("캐릭터 인벤토리 조회 요청 - characterId={}", characterId);

        GetInventoriesByCharacterQuery query = GetInventoriesByCharacterQuery.of(characterId);
