import { useSavingsSettingsStore, type ChangeType } from '@/features/savings/store/useSavingsSettingsStore';
...
const SelectChangeStep = () => {
  ...
  const handleNext = () => {
    if (selectedChangeTypes.length === 0) return;
    goToNextStep();
  };
  ...
  return (
    <>
      ...
      <div className="flex flex-1 flex-col px-6 py-8">
        <h1 className="mb-2 text-xl font-bold text-gray-900">변경할 설정 선택</h1>
